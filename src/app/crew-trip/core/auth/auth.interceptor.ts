...
import { COMMON_CONFIG, MESSAGE } from '../../shared/utils/constant';
			...
			if (error.name === 'TimeoutError') {
				...
				readError(error).then((errorResponse: HttpErrorResponse) => {
					if (errorResponse.status === HttpStatusCode.Unauthorized) {
						...
						errorResponse.status === HttpStatusCode.ServiceUnavailable ||
						...
						errorResponse.status === HttpStatusCode.Conflict ||
