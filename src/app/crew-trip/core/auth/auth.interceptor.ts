...
export function loggingInterceptor(req: HttpRequest<unknown>, next: HttpHandlerFn): Observable<HttpEvent<unknown>> {
  ...
  localStorage.setItem('access_token1', 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbkBnaW1hc3lzLmNvbSIsImlhdCI6MTcyNzQ1MTkyOSwiZXhwIjoxNzI3NDY5OTI5fQ.og8NEzptOR_0NANApLEVORQz6UqWgSnhvXKJZkghLlI3PZuNtrD0PLI4pbpj8DcAR6HmhDzSVyaf_SVv0jfEwg');
