...
@Component({
  ...
  imports: [
    ...
    MatExpansionModule, MatExpansionPanelContent, CharterGeneralComponent, CharterCarRentalComponent,
...
export class CharterDetailComponent extends CommonComponent {
  ...
  @ViewChild('charterHotel', { static: false }) charterHotel: CharterHotelComponent;
  @ViewChild('charterCarRental', { static: false }) charterCarRental: CharterCarRentalComponent;
