...
@Component({
  selector: 'app-domestic-estimated-cost-flight-rate',
  standalone: true,
  imports: [
  ...
  templateUrl: './domestic-estimated-cost-flight-rate.component.html',
  styleUrl: './domestic-estimated-cost-flight-rate.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DomesticEstimatedCostFlightRateComponent implements OnInit {
  ...
  constructor() {
    effect(() => {
      console.log('effect data DomesticEstimatedCostFlightRateComponent: ', this.data())
      if (this.data()) {
