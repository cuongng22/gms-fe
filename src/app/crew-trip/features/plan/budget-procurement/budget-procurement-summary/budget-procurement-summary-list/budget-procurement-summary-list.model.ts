...
export function getDisplayedColumns(type: string, categoryType?: CategoryEnum): string[] {
    const columns: { column: string, visible: boolean }[] = [
        ...
        { column: "num", visible: true },
        { column: "unit", visible: true },
        { column: "unitPrice", visible: true },
        { column: "cost", visible: true },
        { column: "budget", visible: true },
        { column: "procurementValueExVat", visible: true },
        { column: "procurementValue", visible: true },
        { column: "supplierMethod", visible: true },
        { column: "estimatedTime", visible: true },
        { column: "totalTime", visible: true },
        { column: "time", visible: true },
        // { column: "vat", visible: true },
        { column: "planVsEstimate", visible: true },
        { column: "planVsEstimateRate", visible: true },
        { column: "unitPriceYear", visible: true },
