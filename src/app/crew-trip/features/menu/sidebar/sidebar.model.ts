...
export const menu: Menu[] = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      {
        path: 'category/hotel', title: $localize`:@@hotels:Hotels`, icon: 'ri-hotel-bed-line'
      },
      {
        path: 'category/vehicle', title: $localize`:@@transporations:Transporations`, icon: 'ri-car-line'
      },
      {
