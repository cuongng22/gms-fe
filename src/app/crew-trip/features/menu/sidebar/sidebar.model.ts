...
export const menu: Menu[] = [
    {
        ...
        subMenu: [
            {
                path: 'admin/users',
                title: $localize`:@@budgetPlan:Kế hoạch ngân sách`,
                icon: 'ri-calendar-line',
                menu: []
            }, 
            {
                path: 'admin/users',
                title: $localize`:@@dailyFlight schedule:Lịch bay ngày`,
            ...
            {
                path: 'admin/users',
                title: $localize`:@@invoiceDocuments:Chứng từ hóa đơn`,
                icon: 'ri-bill-line',
                menu: []
            }
        ]
    ...
    },
    {
        ...
        subMenu: [
            ...
            },
            {
                ...
                title: $localize`:@@contract:Hợp đồng`,
                icon: 'ri-contract-line',
                menu: []
            },
            {
                path: 'category/users',
                title: $localize`:@@hotel:Khách sạn`,
                icon: 'ri-hotel-bed-fill',
                menu: []
            },
            {
                path: 'category/vehicle',
                title: $localize`:@@carRentalCompany:Nhà xe`,
                icon: 'ri-car-line',
                menu: []
            },
            {
                path: 'category/users',
                title: $localize`:@@flightMarket:Thị trường bay`,
                icon: 'ri-store-line',
                menu: []
            },
            {
                path: 'category/rate',
                title: $localize`:@@exchangeRate:Tỉ giá ngoại tệ`,
                icon: 'ri-exchange-cny-line',
                menu: []
            },
            {
                path: 'category/nation',
                title: $localize`:@@country:Country`,
                icon: 'ri-global-fill',
                menu: []
            },
            {
                path: 'admin/users',
                title: $localize`:@@serviceFee:Service Fee`,
