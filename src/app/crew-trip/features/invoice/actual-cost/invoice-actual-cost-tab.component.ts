...
import {InvoiceActualCostComponent} from "src/app/crew-trip/features/invoice/actual-cost/invoice-actual-cost.component";


@Component({
  selector: 'app-invoice-actual-cost-tab',
  standalone: true,
  imports: [RouterLink, CommonModule, MatCardModule, MatButtonModule, MatMenuModule, MatTableModule, MatPaginatorModule, NgIf, MatCheckboxModule, TitleCasePipe, DataTransformPipe, NgClass, MatFormField, MatSelect, MatOption, MatInput, MatLabel, ReactiveFormsModule, InputSizeComponent, MatError, MatPrefix, MatSuffix, MatTab, MatTabGroup, RoleFunctionComponent, NoDataRowOutlet, ContractDetailComponent, MatDatepickerModule, MatHint, InvoiceActualCostComponent],
  templateUrl: './invoice-actual-cost-tab.component.html',
  styleUrl: './invoice-actual-cost-tab.component.scss',
})


export class InvoiceActualCostTabComponent implements OnInit {
  partnerType = 'HOTEL';
  step = 1;
  id: any;
  readMode: any;
